...
public class MainActivity extends AppCompatActivity  implements
                ...
                switch (resultCode) {
                    case Activity.RESULT_OK:
                        ...
                        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                            toast("Por favor dar permisos a gps.");
                            return;
                        }
                    ...
                    case Activity.RESULT_CANCELED:
                        ...
                        toast("Active el GPS para registrar puntos");
                        break;
                }
                break;
        }
    ...
    private void changeStatusAfterGetLastLocation(final String value, final String changeby) {
            if(value == "1"){
                toast("Recoleccion gps iniciada!");
                ...
                toast("Recoleccion GPS detenida!");
